...
C   
      ...
      REAL(8) :: G1,K1,E1,m_et,b_et, m_E1, b_E1
      ! shear modulus of visco-elastic relaxation mode 1 
      REAL(8) :: deltaH,m_deltaH,b_deltaH
      ! enthalpy 
      REAL(8) :: Astar 
      ! A star 
      REAL(8) :: taustar
      ! tau star 
      REAL(8) :: vstar, m_vstar, b_vstar 
      ! v*
      REAL(8) :: mu  
...
C      et = props(5)           ! gt, for calculating g1
      lamda = props(5)        ! lamda  
      E1 = props(6)           ! G1
C      deltaH = props(6)       ! enthalpy
      Astar = props(7)        ! A0
C      vstar = props(8)       !  v* shear volume 
      mu = props(8)          ! pressure co-efficient
      hsoft = props(9)       ! slope of softening
      Dinf = props(10)        ! saturation volume of softening parameter
      H = props(11)           ! slope of plasticity curve  
      m_et = props(12)	      ! linear coeff of et
C      b_et = props(13)        ! bias coeff of et 
      m_E1 = props(13)	      ! linear coeff of et
C      b_E1 = props(15)        ! bias coeff of et 
      m_deltaH = props(14)
C      b_deltaH = props(16)
      m_vstar  = props(15)
C      b_vstar  = props(18)
      ...
      et       = m_et * dlog(R1+Tstar)
      E1       = m_E1 * dlog(R1+Tstar) 
      deltaH   = m_deltaH * dlog(R1+Tstar) 
      vstar    = m_vstar *  dlog(R1+Tstar)  	  
